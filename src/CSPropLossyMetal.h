...
/*!
  This is a lossy metal property for 3D volumetric objects.
  It models a metal with finite conductivity using surface impedance
  boundary conditions (SIBC) applied to the exterior surfaces of the 3D volume.
  Internally the volume is treated as PEC.
  */
